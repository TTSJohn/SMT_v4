	...
	render() {
		return (
			<Grid>
				<Carousel>
				  <Carousel.Item>
				    <Image width={900} height={500} alt="900x500" src="assets/massagePhoto4.jpg" />
				  ...
				  <Carousel.Item>
				    <Image width={900} height={500} alt="900x500" src="assets/massagePhoto2.jpeg" />
				    <Carousel.Caption className="editText">
				  ...
				  <Carousel.Item>
				    <Image width={900} height={500} alt="900x500" src="assets/massagePhoto3.jpeg" />
				    <Carousel.Caption className="editText">
